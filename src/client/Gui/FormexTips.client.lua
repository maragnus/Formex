...
local FormexClient = require(script.Parent.Parent:WaitForChild("Client"))
local Formex = FormexClient.Formex
local FormexUI = require(script.Parent.Parent:WaitForChild("FormexUI"))
local FormexDesign = require(script.Parent.Parent:WaitForChild("Design"))
